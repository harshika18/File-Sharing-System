...
def get_filename():
	for i in range(0, 2):
		if i == 0:
			...
			other_client = input('Please spacify the client: ')
			# filename = '..\\' + other_client + '\\' + filename
	...
	filename_statinfo = (filename, statinfo, other_client)
...
def client():
	...
	if command.lower() == 'put':
		...
		other_client = filename_statinfo[2]	
		print("File Name::::::::::" + other_client)	
		# for i in range(4):
