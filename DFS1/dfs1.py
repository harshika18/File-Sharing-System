...
def put(new_dir_path):
	...
	print("CLient name:::::::::" + other_client)
	...
	if os.path.isdir(new_folder_path) == False:
		...
		pass
	# Successfully created the folder C:\Users\harsh\Dropbox\My PC (DESKTOP-26NAJTK)\Downloads\PythonDFS-master\PythonDFS-master\DFS1\Alice\The Tempest
